...
class OrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update order" do
    patch order_url(@order), params: { order: { quantity: @order.quantity, product_id: @order.product_id, slip_id: @order.slip_id, status: @order.status, user_id: @order.user_id } }
